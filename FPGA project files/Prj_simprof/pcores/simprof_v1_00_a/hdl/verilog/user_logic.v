...
// Date:              Mon Aug 24 16:27:59 2015 (by Create and Import Peripheral Wizard)
...
//----------------------------------------------------------------------------
  ...
  simprof simprof_inst(.clk(Bus2IP_Clk),.reset(slv_reg0[31]),.P_Trace_PC(P_Trace_PC),.P_Trace_Valid_Instr(P_Trace_Valid_Instr),.P_Count(slv_reg1));
