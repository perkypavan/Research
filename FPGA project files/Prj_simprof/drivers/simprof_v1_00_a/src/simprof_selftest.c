/*****************************************************************************
* Filename:          D:\Pavan_FPGA_Projects\Prj_simprof/drivers/simprof_v1_00_a/src/simprof_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the simprof driver
...
XStatus SIMPROF_SelfTest(void * baseaddr_p)
{
  ...
  SIMPROF_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = SIMPROF_mReadSlaveReg0(baseaddr, 0);
  ...
  SIMPROF_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = SIMPROF_mReadSlaveReg1(baseaddr, 0);
