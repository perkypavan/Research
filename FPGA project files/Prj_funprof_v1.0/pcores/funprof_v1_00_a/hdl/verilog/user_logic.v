...
// Date:              Mon Sep 07 12:22:30 2015 (by Create and Import Peripheral Wizard)
...
//----------------------------------------------------------------------------
  ...
  wire       [0 : C_SLV_DWIDTH-1]           slv_reg1;
  ...
  funprof funprof_inst(.clk(Bus2IP_Clk),.reset(slv_reg0[31]),.P_Trace_Instruction(P_Trace_Instruction),.P_Trace_Valid_Instr(P_Trace_Valid_Instr),.P_Count(slv_reg1));
